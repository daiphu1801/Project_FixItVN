...
abstract class Hilt_WorkerProfileFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerProfileFragment_GeneratedInjector) this.generatedComponent()).injectWorkerProfileFragment(UnsafeCasts.<WorkerProfileFragment>unsafeCast(this));
    }
  }

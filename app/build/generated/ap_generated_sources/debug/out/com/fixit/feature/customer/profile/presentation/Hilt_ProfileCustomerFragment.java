...
abstract class Hilt_ProfileCustomerFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ProfileCustomerFragment_GeneratedInjector) this.generatedComponent()).injectProfileCustomerFragment(UnsafeCasts.<ProfileCustomerFragment>unsafeCast(this));
    }
  }

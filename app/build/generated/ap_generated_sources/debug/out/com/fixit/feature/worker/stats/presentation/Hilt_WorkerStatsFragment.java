...
abstract class Hilt_WorkerStatsFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerStatsFragment_GeneratedInjector) this.generatedComponent()).injectWorkerStatsFragment(UnsafeCasts.<WorkerStatsFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_WorkerInvoiceFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerInvoiceFragment_GeneratedInjector) this.generatedComponent()).injectWorkerInvoiceFragment(UnsafeCasts.<WorkerInvoiceFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_CustomerCancelOrderFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerCancelOrderFragment_GeneratedInjector) this.generatedComponent()).injectCustomerCancelOrderFragment(UnsafeCasts.<CustomerCancelOrderFragment>unsafeCast(this));
    }
  }

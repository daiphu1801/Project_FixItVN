...
abstract class Hilt_CustomerSearchFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerSearchFragment_GeneratedInjector) this.generatedComponent()).injectCustomerSearchFragment(UnsafeCasts.<CustomerSearchFragment>unsafeCast(this));
    }
  }

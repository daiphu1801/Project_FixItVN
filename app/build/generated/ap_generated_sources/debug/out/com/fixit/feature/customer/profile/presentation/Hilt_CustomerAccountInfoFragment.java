...
abstract class Hilt_CustomerAccountInfoFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerAccountInfoFragment_GeneratedInjector) this.generatedComponent()).injectCustomerAccountInfoFragment(UnsafeCasts.<CustomerAccountInfoFragment>unsafeCast(this));
    }
  }

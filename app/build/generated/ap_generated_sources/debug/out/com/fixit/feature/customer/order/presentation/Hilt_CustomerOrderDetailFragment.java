...
abstract class Hilt_CustomerOrderDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerOrderDetailFragment_GeneratedInjector) this.generatedComponent()).injectCustomerOrderDetailFragment(UnsafeCasts.<CustomerOrderDetailFragment>unsafeCast(this));
    }
  }

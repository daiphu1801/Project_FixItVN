...
abstract class Hilt_FavoriteWorkersFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FavoriteWorkersFragment_GeneratedInjector) this.generatedComponent()).injectFavoriteWorkersFragment(UnsafeCasts.<FavoriteWorkersFragment>unsafeCast(this));
    }
  }

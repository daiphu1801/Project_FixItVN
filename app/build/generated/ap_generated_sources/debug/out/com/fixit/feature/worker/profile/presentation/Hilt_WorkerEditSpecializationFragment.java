...
abstract class Hilt_WorkerEditSpecializationFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerEditSpecializationFragment_GeneratedInjector) this.generatedComponent()).injectWorkerEditSpecializationFragment(UnsafeCasts.<WorkerEditSpecializationFragment>unsafeCast(this));
    }
  }

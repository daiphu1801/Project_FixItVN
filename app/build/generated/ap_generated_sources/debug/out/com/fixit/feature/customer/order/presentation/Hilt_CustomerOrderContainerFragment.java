...
abstract class Hilt_CustomerOrderContainerFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerOrderContainerFragment_GeneratedInjector) this.generatedComponent()).injectCustomerOrderContainerFragment(UnsafeCasts.<CustomerOrderContainerFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_WorkerHomeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerHomeFragment_GeneratedInjector) this.generatedComponent()).injectWorkerHomeFragment(UnsafeCasts.<WorkerHomeFragment>unsafeCast(this));
    }
  }

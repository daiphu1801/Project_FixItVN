...
abstract class Hilt_WorkerChatFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerChatFragment_GeneratedInjector) this.generatedComponent()).injectWorkerChatFragment(UnsafeCasts.<WorkerChatFragment>unsafeCast(this));
    }
  }

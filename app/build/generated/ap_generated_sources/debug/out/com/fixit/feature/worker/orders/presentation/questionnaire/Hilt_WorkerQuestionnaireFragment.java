package com.fixit.feature.worker.orders.presentation.questionnaire;
...
abstract class Hilt_WorkerQuestionnaireFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerQuestionnaireFragment_GeneratedInjector) this.generatedComponent()).injectWorkerQuestionnaireFragment(UnsafeCasts.<WorkerQuestionnaireFragment>unsafeCast(this));
    }
  }

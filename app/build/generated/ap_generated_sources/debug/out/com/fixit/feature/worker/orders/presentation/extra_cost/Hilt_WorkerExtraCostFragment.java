...
abstract class Hilt_WorkerExtraCostFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerExtraCostFragment_GeneratedInjector) this.generatedComponent()).injectWorkerExtraCostFragment(UnsafeCasts.<WorkerExtraCostFragment>unsafeCast(this));
    }
  }

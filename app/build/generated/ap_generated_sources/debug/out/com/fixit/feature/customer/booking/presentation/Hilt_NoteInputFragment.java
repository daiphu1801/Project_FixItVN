...
abstract class Hilt_NoteInputFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NoteInputFragment_GeneratedInjector) this.generatedComponent()).injectNoteInputFragment(UnsafeCasts.<NoteInputFragment>unsafeCast(this));
    }
  }

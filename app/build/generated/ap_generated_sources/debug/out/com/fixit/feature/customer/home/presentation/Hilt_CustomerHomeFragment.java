...
abstract class Hilt_CustomerHomeFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerHomeFragment_GeneratedInjector) this.generatedComponent()).injectCustomerHomeFragment(UnsafeCasts.<CustomerHomeFragment>unsafeCast(this));
    }
  }

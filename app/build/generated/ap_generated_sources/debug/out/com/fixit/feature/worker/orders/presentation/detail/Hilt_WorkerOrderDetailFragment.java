...
abstract class Hilt_WorkerOrderDetailFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerOrderDetailFragment_GeneratedInjector) this.generatedComponent()).injectWorkerOrderDetailFragment(UnsafeCasts.<WorkerOrderDetailFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_WorkerJobFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerJobFragment_GeneratedInjector) this.generatedComponent()).injectWorkerJobFragment(UnsafeCasts.<WorkerJobFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_OrderDetailFinishedFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OrderDetailFinishedFragment_GeneratedInjector) this.generatedComponent()).injectOrderDetailFinishedFragment(UnsafeCasts.<OrderDetailFinishedFragment>unsafeCast(this));
    }
  }

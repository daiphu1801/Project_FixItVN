...
abstract class Hilt_CustomerFindingWorkerFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerFindingWorkerFragment_GeneratedInjector) this.generatedComponent()).injectCustomerFindingWorkerFragment(UnsafeCasts.<CustomerFindingWorkerFragment>unsafeCast(this));
    }
  }

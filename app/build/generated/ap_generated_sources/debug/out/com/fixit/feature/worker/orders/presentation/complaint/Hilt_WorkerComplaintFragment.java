...
abstract class Hilt_WorkerComplaintFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerComplaintFragment_GeneratedInjector) this.generatedComponent()).injectWorkerComplaintFragment(UnsafeCasts.<WorkerComplaintFragment>unsafeCast(this));
    }
  }

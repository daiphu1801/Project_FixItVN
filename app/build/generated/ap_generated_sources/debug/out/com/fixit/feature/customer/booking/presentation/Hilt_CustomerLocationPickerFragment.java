...
abstract class Hilt_CustomerLocationPickerFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerLocationPickerFragment_GeneratedInjector) this.generatedComponent()).injectCustomerLocationPickerFragment(UnsafeCasts.<CustomerLocationPickerFragment>unsafeCast(this));
    }
  }

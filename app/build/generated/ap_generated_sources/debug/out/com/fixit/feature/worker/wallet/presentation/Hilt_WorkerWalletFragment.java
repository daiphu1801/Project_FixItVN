...
abstract class Hilt_WorkerWalletFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerWalletFragment_GeneratedInjector) this.generatedComponent()).injectWorkerWalletFragment(UnsafeCasts.<WorkerWalletFragment>unsafeCast(this));
    }
  }

...
abstract class Hilt_WorkerOrdersFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkerOrdersFragment_GeneratedInjector) this.generatedComponent()).injectWorkerOrdersFragment(UnsafeCasts.<WorkerOrdersFragment>unsafeCast(this));
    }
  }

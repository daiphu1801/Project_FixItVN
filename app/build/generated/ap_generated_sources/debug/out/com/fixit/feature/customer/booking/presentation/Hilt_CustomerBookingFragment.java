...
abstract class Hilt_CustomerBookingFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomerBookingFragment_GeneratedInjector) this.generatedComponent()).injectCustomerBookingFragment(UnsafeCasts.<CustomerBookingFragment>unsafeCast(this));
    }
  }

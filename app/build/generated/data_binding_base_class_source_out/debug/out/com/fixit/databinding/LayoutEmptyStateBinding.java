...
public final class LayoutEmptyStateBinding implements ViewBinding {
  ...
  private LayoutEmptyStateBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout layoutEmpty,
  ...
  public static LayoutEmptyStateBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      LinearLayout layoutEmpty = (LinearLayout) rootView;
      ...
      return new LayoutEmptyStateBinding((LinearLayout) rootView, layoutEmpty, tvEmptyMessage);
    }

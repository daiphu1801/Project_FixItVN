...
public interface CustomerBookingRepository {
    void createBooking(Integer serviceId, String address, BigDecimal lat, BigDecimal lng, String issueDescription, String paymentMethod, ResultCallback<CustomerBooking> callback);
    ...
    void processPayment(String bookingId, String paymentMethod, ResultCallback<Void> callback);
    void simulateBankTransfer(String bookingId, ResultCallback<Void> callback);
}

...
public class WorkerStatsFragment extends BaseFragment<FragmentWorkerStatsBinding> {
    ...
    private void setupAppointmentList() {
        java.util.List<com.fixit.feature.worker.home.domain.model.Appointment> mockAppointments = java.util.Arrays.asList(
                new com.fixit.feature.worker.home.domain.model.Appointment("14:00 - 15:30", "Sửa máy giặt", "123 Xuân Thủy, Cầu Giấy"),
                new com.fixit.feature.worker.home.domain.model.Appointment("16:30 - 18:00", "Lắp điều hòa", "45 Cầu Giấy, Hà Nội"),
                new com.fixit.feature.worker.home.domain.model.Appointment("09:00 Mai", "Sửa bình nóng lạnh", "12 Trần Thái Tông")
        );

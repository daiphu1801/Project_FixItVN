...
import com.fixit.databinding.FragmentWorkerLocationPickerBinding;
import dagger.hilt.android.AndroidEntryPoint;

@AndroidEntryPoint
public class WorkerLocationPickerFragment extends BaseFragment<FragmentWorkerLocationPickerBinding> {

    public static final String REQUEST_KEY = "worker_location_request";
    ...
    @NonNull
    @Override
    protected FragmentWorkerLocationPickerBinding inflateViewBinding(@NonNull LayoutInflater inflater, ViewGroup container) {
        return FragmentWorkerLocationPickerBinding.inflate(inflater, container, false);
    }
